...
export function renderAccessibilityPanel() {
  return [
    ...
    `<button type="button" data-accessibility-advanced-open aria-controls="accessibility-settings-dialog" aria-expanded="false">${renderIcon('gear', 'ui-icon')}Расширенные настройки</button>`,
    '<button type="button" data-accessibility-standard>Обычная версия сайта</button>',
    `<button type="button" data-accessibility-close>${renderIcon('collapse', 'ui-icon')}Свернуть</button>`,
    '</div></fieldset>',
    '</div>',
