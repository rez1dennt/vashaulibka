...
const renderPrivacyPolicy = () => {
  ...
  const sections = [
    ...
    privacySection('privacy-updates', 12, 'Изменение политики', '<p>Актуальная редакция постоянно доступна на этой странице. Оператор обновляет Политику при изменении законодательства, целей, состава данных, поставщиков или способов обработки.</p><p><strong>Редакция от 12 августа 2026 года.</strong></p>'),
  ].join('');
