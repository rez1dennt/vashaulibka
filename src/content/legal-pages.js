...
const renderPrivacyPolicy = () => {
  ...
  const sections = [
    ...
    privacySection('privacy-storage', 11, 'Локальные настройки браузера', '<p>Текущая версия сайта сохраняет в localStorage только выбор необязательных технологий и режим отображения для слабовидящих. Эти значения описаны на странице <a href="cookies.html">«Технические настройки и cookies»</a>. Пользователь может изменить выбор через настройки cookies или удалить данные сайта средствами браузера.</p>'),
