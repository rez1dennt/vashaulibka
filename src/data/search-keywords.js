export const SEARCH_PAGE_META = Object.freeze({
  ...
  'documents.html': { category: 'Документы', keywords: ['документы', 'лицензия', 'ОГРН', 'прайс', 'прайс-лист', 'СОУТ', 'охрана труда', 'постановление 659', 'постановление 736', 'приказ 118н', 'приказ 804н', 'права пациентов', 'стандарты', 'клинические рекомендации'] },
